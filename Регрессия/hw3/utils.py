...
def train_model(dataset, target, feature_names, show_results=False, show_summary=False, pairwise=False, return_norm_tests=False, robust=False):
    ...
    if robust == True:
        ...
        #model = sm.RLM(dataset[target], X, M=sm.robust.norms.HuberT()).fit()
